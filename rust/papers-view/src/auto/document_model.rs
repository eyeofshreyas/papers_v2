...
use crate::{AnnotationEditingState, AnnotationModel, PageLayout, SizingMode, ffi};
use glib::{
...
impl DocumentModel {
    ...
    pub fn connect_annotation_editing_state_notify<F: Fn(&Self) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::annotation-editing-state".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
    ...
    pub fn connect_inverted_colors_notify<F: Fn(&Self) + 'static>(&self, f: F) -> SignalHandlerId {
        ...
        unsafe {
            ...
            connect_raw(
                self.as_ptr() as *mut _,
                c"notify::inverted-colors".as_ptr(),
                Some(std::mem::transmute::<*const (), unsafe extern "C" fn()>(
